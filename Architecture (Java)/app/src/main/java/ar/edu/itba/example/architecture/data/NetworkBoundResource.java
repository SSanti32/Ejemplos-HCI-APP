...
import ar.edu.itba.example.architecture.data.remote.ApiResponse;
import ar.edu.itba.example.architecture.data.remote.RemoteError;
import ar.edu.itba.example.architecture.data.remote.RemoteResult;
            ...
            if (response.getError() != null) {
                ...
                result.addSource(dbSource,
                        newData -> {
                            ...
                            ar.edu.itba.example.architecture.model.Error modelError = new ar.edu.itba.example.architecture.model.Error(remoteError.getCode(), remoteError.getDescription().get(0));
